...
#
# bashunit.bash: a unit test framework in Bash.
#
...
#   #!/bin/bash
#
#   source "$(rlocation "bazel_sh_test/bashunit/bashunit.bash")" \
#     || { echo "Could not source bashunit.bash" >&2; exit 1; }
#
#   # Test that foo works.
#   function test_foo() {
...
[[ -n "$BASH_VERSION" ]] ||
  { echo "bashunit.bash only works with bash!" >&2; exit 1; }
...
source "${DIR}/bashunit_utils.sh" || { echo "bashunit_utils.sh not found" >&2; exit 1; }
