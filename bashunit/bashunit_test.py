...
# This allows the internal test to use the same runfiles to load bashunit.bash.
_TEST_PREAMBLE = """
#!/bin/bash
...
source "$(rlocation "rules_bazel_integration_test/bashunit/bashunit.bash")" \
